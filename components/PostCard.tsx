...
const PostCard = ({ post }: PostCardProps) => {
  return (
    <div className='bg-white shadow-lg rounded-lg p-0 lg:p-8 pb-12 mb-8'>
      {post.title}
      {post.des}
      <Link href={'/posts/contents/tt'} >
        <h1 className='transition duration-700 mb-8 cursor:pointer text-center hover:text-pink-600 text-3xl font-semibold'>
          test
        </h1>
        <p className='text-center text-lg text-gray-700 font-normal px-4 lg:px-20 mb-8'>EXCERPT</p>
      </Link>
      <div className='block lg:flex text-center item-center justify-center mb-8 w-full'>
        ...
        <div className='font-medium text-gray-700'>
          ...
          <span className="align-middle">1234-67-40</span>
        </div>
      </div>
    </div>
  )
